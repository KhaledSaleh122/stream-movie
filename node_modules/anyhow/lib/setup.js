 ...
 */
const libSetup = (anyhow, lib, libOptions) => {
    try {
        if (!libOptions)
            libOptions = {};
        let libObj = lib;
        ...
        if ((0, utils_1.isObject)(lib)) {
            ...
            if ((0, utils_1.isFunction)(libObj.log)) {
                anyhow._logger = lib;
                return;
            }
        }
        ...
        anyhow._logger = {
            name: libObj.name ? libObj.name : lib,
            log: null
        };
            ...
            try {
                ...
                anyhow._logger.log = function (level, message) {
                    ...
                    const writeOptions = {
                        ...
                        partialSuccess: (0, utils_1.isNil)(libOptions.partialSuccess) ? true : libOptions.partialSuccess
                    };
                    const entry = gcloud.entry(metadata, message);
                    if ((0, utils_1.isFunction)(libOptions.callback)) {
        ...
        /* istanbul ignore next */
        const libName = (0, utils_1.isString)(lib) ? lib : lib.name;
        console.error(`Anyhow: can't setup ${libName}`);
        console.error(ex);
        throw ex;
    }
};
exports.libSetup = libSetup;
